"""Modal deployment entry point for the Doppelganger FastAPI service.
...
# sklearn pinned to the EXACT version recorded in the artifact's metadata
# (see doppelganger.joblib's "sklearn_version") - a mismatch here is a
# classic way to silently get a broken unpickle or a different model.
image = (

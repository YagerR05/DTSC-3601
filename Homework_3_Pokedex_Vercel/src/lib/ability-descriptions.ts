// Generated by scripts/fetch-ability-descriptions.mjs from PokeAPI effect text.
...
export const ABILITY_DESCRIPTIONS: Record<string, string> = {
  ...
  "As One Glastrier": "Combines the effects of Unnerve and Chilling Neigh.",
  "As One Spectrier": "Combines the effects of Unnerve and Grim Neigh.",
  ...
  "Neuroforce": "Increases super-effective damage dealt to 1.25×.",
